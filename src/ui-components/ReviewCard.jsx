      ...
      >
        ...
        >
          <Text
            ...
            {...getOverrideProps(
              overrides,
              "Information about this product.4164"
            )}
          ></Text>
          <Text
            fontFamily="Inter"
            ...
            {...getOverrideProps(
              overrides,
              "Information about this product.4165"
            )}
          ></Text>
        </Flex>
        <Flex
        ...
        >
          <Flex
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Rating4168")}
          >
            <Flex
              width="unset"
              height="unset"
              {...getOverrideProps(overrides, "Rating4169")}
            ></Flex>
            <Text
              fontFamily="Inter"
              fontSize="16px"
